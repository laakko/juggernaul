...
public class ShareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO QR-code should get token from backend server
        try {
            Bitmap barcode_bitmap = encodeAsBitmap("Vikstrom.info", BarcodeFormat.QR_CODE, 800, 600);

            // Add QR-code to imageview
            imgBarcode = (ImageView) findViewById(R.id.imgBarcode);
            imgBarcode.setImageBitmap(barcode_bitmap);
